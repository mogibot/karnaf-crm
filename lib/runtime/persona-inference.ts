// Pure helper that infers a coarse communication persona from a lead's
// inbound messages + first-touch source. The model uses persona to scale
// its tone (more data for analysts, more brevity for impulsive leads,
// counter-objections for skeptics, partner-aware for delegators).
//
// Mirrored by supabase/functions/_shared/persona-inference.ts.
