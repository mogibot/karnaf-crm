...
async function replayOne(
  ...
  // Preserve safe headers from the original (signature stays valid because
  // body is identical).
  ...
  try {
    ...
    // Note: the target webhook itself will insert a fresh webhook_inbox
    // row via persistWebhookInbox; we don't double-insert here.
